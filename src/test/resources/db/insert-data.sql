insert into users values(1, 'Andrew', 'Panas', '2021-04-22 20:26:00', 'abs@mail.ru', '$2y$12$XhjAX4fRULP4ZBJpYR/gMeOLkxsljJCBe52FDtA1xEOows.X4/1pu', 1);
insert into users values(2, 'Andrew2', 'Panas', '2021-04-22 20:27:00', 'qwerty@mail.ru', '$2y$12$78sNY9AYgkVeODvunb3jiOfcRGQFyhOk.kfwSnYKz7YfJgbsiBDNm', 1);
...
insert into game_objects values(1, 'Text db', 'Some text', '2021-04-22 20:26:00', '2021-04-22 20:26:00', 1);
